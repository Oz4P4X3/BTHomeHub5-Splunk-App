...
data = driver.find_element_by_xpath('//*[@id="frame_div"]/table/tbody/tr[1]/td/table/tbody/tr[2]/td[2]').text.replace(" ", "").split("/")

# arrange output into a Splunk friendly way
print("data_transmitted=" + data[0] + " " + "data_received=" + data[1])
